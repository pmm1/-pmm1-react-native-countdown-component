...
class CountDown extends React.Component {
  ...
  constructor(props) {
    ...
    this.timerEventListener = null;
  }

  componentDidMount() {
    this.timerEventListener = AppState.addEventListener(
      "change",
  ...
  componentWillUnmount() {
    ...
    this.timerEventListener.remove();
    // AppState.removeEventListener("change", this._handleAppStateChange); // This is deprecated...
  }
